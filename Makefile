...
pkgdatadir = $(datadir)/ndnrtc ubuntu demoapp
pkgincludedir = $(includedir)/ndnrtc ubuntu demoapp
pkglibdir = $(libdir)/ndnrtc ubuntu demoapp
pkglibexecdir = $(libexecdir)/ndnrtc ubuntu demoapp
...
am__v_lt_0 = --silent
am__v_lt_1 = 
demoapp_LINK = $(LIBTOOL) $(AM_V_lt) --tag=CXX $(AM_LIBTOOLFLAGS) \
	$(LIBTOOLFLAGS) --mode=link $(CXXLD) $(AM_CXXFLAGS) \
	$(CXXFLAGS) $(demoapp_LDFLAGS) $(LDFLAGS) -o $@
...
demoapp_LDFLAGS = -L/home/jcw/libconfig-1.5/build/lib -L/home/jcw/ndn-cpp/build/lib -L/home/jcw/ndnrtc-boost/cpp/build/lib -L/usr/local/lib -lconfig++ -lndn-cpp -lndnrtc -lX11 -lXdamage -lXrender -lXext -lnss3 -lssl3 -lXfixes -lXcomposite -lglfw -lGLEW /home/jcw/OpenGL-tutorial_v0014_21/build/external/libGLEW_190.a -lGLU -lGL -lSM -lICE -lX11 -lXext 
...
demoapp$(EXEEXT): $(demoapp_OBJECTS) $(demoapp_DEPENDENCIES) $(EXTRA_demoapp_DEPENDENCIES) 
	@rm -f demoapp$(EXEEXT)
	$(AM_V_CXXLD)$(demoapp_LINK) $(demoapp_OBJECTS) $(demoapp_LDADD) $(LIBS)
...
src/demoapp-main.o: src/main.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(demoapp_CPPFLAGS) $(CPPFLAGS) $(AM_CXXFLAGS) $(CXXFLAGS) -MT src/demoapp-main.o -MD -MP -MF src/$(DEPDIR)/demoapp-main.Tpo -c -o src/demoapp-main.o `test -f 'src/main.cpp' || echo '$(srcdir)/'`src/main.cpp
	$(AM_V_at)$(am__mv) src/$(DEPDIR)/demoapp-main.Tpo src/$(DEPDIR)/demoapp-main.Po
#	$(AM_V_CXX)source='src/main.cpp' object='src/demoapp-main.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(demoapp_CPPFLAGS) $(CPPFLAGS) $(AM_CXXFLAGS) $(CXXFLAGS) -c -o src/demoapp-main.o `test -f 'src/main.cpp' || echo '$(srcdir)/'`src/main.cpp

src/demoapp-main.obj: src/main.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(demoapp_CPPFLAGS) $(CPPFLAGS) $(AM_CXXFLAGS) $(CXXFLAGS) -MT src/demoapp-main.obj -MD -MP -MF src/$(DEPDIR)/demoapp-main.Tpo -c -o src/demoapp-main.obj `if test -f 'src/main.cpp'; then $(CYGPATH_W) 'src/main.cpp'; else $(CYGPATH_W) '$(srcdir)/src/main.cpp'; fi`
	$(AM_V_at)$(am__mv) src/$(DEPDIR)/demoapp-main.Tpo src/$(DEPDIR)/demoapp-main.Po
